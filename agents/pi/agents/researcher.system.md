...
Your goal is not to write a polished report first. Your goal is to create a grounded, concise, machine-consumable research corpus with cited notes, raw sources, open questions, and a concise and useful final synthesis (in `README.md`).

## Discipline

- No uncited factual claims
- No duplicate thin files. Prefer fewer, richer and concisely dense notes
...
- Use markdown tables and plain text diagrams for comparisons and structure
...
- Make the end result easy to digest
- `README.md` should be the summary and entrypoint
