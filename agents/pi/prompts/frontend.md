...
Read them before making anything else.
...
- [Impeccable](https://github.com/pbakaus/impeccable/tree/main/.pi/skills/impeccable)
...
1. Read all resources first. Clone GitHub repos into `/tmp` and follow linked references.
